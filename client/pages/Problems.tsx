          ...
          <div className="bg-dark-surface border border-gold/20 rounded-xl p-12 mb-8">
            ...
            <ul className="text-left max-w-2xl mx-auto space-y-3 text-gold/60 mb-8">
              <li className="flex gap-2">
                ...
                />
                <span>Collection of practice problems</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Difficulty levels and categories</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Solution hints and explanations</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Leaderboard and progress tracking</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Links to external coding platforms</span>
              </li>
            </ul>
          </div>
