          ...
          <div className="bg-dark-surface border border-gold/20 rounded-xl p-12 mb-8">
            ...
            <ul className="text-left max-w-2xl mx-auto space-y-3 text-gold/60 mb-8">
              <li className="flex gap-2">
                ...
                />
                <span>Curated learning materials and tutorials</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Programming language guides</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Data structure and algorithm resources</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Recommended books and courses</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>External tool and platform links</span>
              </li>
            </ul>
          </div>
