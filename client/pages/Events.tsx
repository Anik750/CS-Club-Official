            ...
            <ul className="text-left max-w-2xl mx-auto space-y-3 text-gold/60 mb-8">
              ...
              <li className="flex gap-2">
                <ArrowRight
                  ...
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Event calendar and schedule</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Event details and registration</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Past events and photo galleries</span>
              </li>
              <li className="flex gap-2">
                <ArrowRight
                  size={20}
                  className="text-gold flex-shrink-0 mt-1"
                />
                <span>Hackathon and competition information</span>
              </li>
            </ul>
          </div>
